...
$sql="insert into customer(name,gender,dob,nominee,account,address,mobile,email,password,branch,ifsc,accstatus) values('$name','$gender','$dob','$nominee','$type','$address','$mobile',
    '$email','$password','$branch','$ifsc','ACTIVE')";
mysql_query($sql) or die(mysql_error());
mysql_query($sql1) or die(mysql_error());
$sql4="insert into passbook".$id."(transactiondate,name,branch,ifsc,credit,debit,amount,narration) values('$date','$name','$branch','$ifsc','$credit','0','$credit','Account Open')";
