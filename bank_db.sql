...
(1, 'admin', 'M', '1994-01-01', 'unmarried', 'developer', 'globsyn kolkata', '18003004000', 'admin', 'admin', '2017-01-01 00:00:00');
...
ALTER TABLE staff ALTER lastlogin SET DEFAULT '2010/10/31 12:25:00';
ALTER TABLE customer ALTER lastlogin SET DEFAULT '2010/10/31 12:25:00';
