...
<?php
   ...
   //select the last transaction id in the sender's passbook
    ...
    elseif($s_total<500)
    {
        ...
        $sql2="insert into passbook".$sender_id."(transactiondate,name,branch,ifsc,credit,debit,amount,narration) values('$date','$s_name','$s_branch','$s_ifsc','0','$t_amount','$s_total','TO $r_name')";
